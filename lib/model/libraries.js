(function() {
  var DefaultLibraryCreator, Libraries, Library, LibraryCreator, LoggableObject, Q, defaultOptions, path, _,
  ...
  Libraries = (function(_super) {
    __extends(Libraries, _super);
    ...
    function Libraries(options) {
      ...
      Libraries.__super__.constructor.call(this, "LIBRARIES", options);
      ...
      this.libraryCreators = this.internalSetupLibraryCreators();
    ...
    Libraries.prototype.internalSetupLibraryCreators = function() {
      ...
      return this.libraryCreators = _.filter(this.libraryCreators, function(libraryCreator) {
        return libraryCreator != null;
      });
    };

    Libraries.prototype.internalSetupLibraryCreator = function(creator) {
      var libraryCreator;
    ...
    Libraries.prototype.internalCreateLibrary = function(libraryId) {
    ...
    Libraries.prototype.internalChooseLibraryCreator = function(libraryId) {
      var creator, promises;
      this.trace("Trying to choose library creator for library id=" + libraryId);
      promises = (function() {
      ...
      return Q.all(promises).then((function(_this) {
        return function(answers) {
          ...
          _this.warn("No creators can create library id=" + libraryId);
          return null;
        };
      })(this));
    };

    Libraries.prototype.internalCreateLibraryByLibraryCreator = function(libraryId, creator) {
      var deferred;
      deferred = Q.defer();
    ...
    Libraries.prototype.internalCanLibraryCreatorCreateLibrary = function(libraryId, creator) {
      var deferred;
      deferred = Q.defer();
    ...
    Libraries.prototype.getLibrary = function(libraryId) {
      return Q.fcall((function(_this) {
        return function() {
          if (!_.isString(libraryId)) {
            throw new Error("LibraryId must be informed");
          ...
          if ((_this._allLibraries[libraryId] != null) && _this._allLibraries[libraryId] instanceof Library) {
            ...
            return Q.fcall(function() {
              return _this._allLibraries[libraryId];
            });
          } else {
    ...
    Libraries.prototype.getCalculatedLibraries = function() {
