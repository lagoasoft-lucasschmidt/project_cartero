  ...
  LoggableObject = (function() {
    ...
    CustomConsoleTransport = (function(_super) {
      ...
      CustomConsoleTransport.prototype.log = function(level, message, meta, callback) {
        ...
        console.log("" + (meta != null ? meta.pid : void 0) + " - " + ((meta != null ? (_ref1 = meta.user) != null ? _ref1.email : void 0 : void 0) || 'anon') + " " + tags['tags'] + " " + (moment().format("MMMM Do YYYY, h:mm:ss a").date) + " - " + level[level] + " - " + message[level]);
        return callback();
      };
