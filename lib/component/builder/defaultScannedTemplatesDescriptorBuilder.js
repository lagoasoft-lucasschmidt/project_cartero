(function() {
  var DefaultLibrariesDescriptorBuilder, DefaultScannedTemplatesDescriptorBuilder, DefaultTemplateOwnFilesLibraryCreator, LibrariesDescriptorBuilder, Library, LibraryCreator, Q, ScannedTemplate, ScannedTemplatesDescriptorBuilder, carteroExtendsRegExp, carteroRequiresRegExp, defaultOptions, findAllFilesBelowFolder, findFilesInFolder, fs, kCarteroExtendsDirective, kCarteroRequiresDirective, path, _, _s,
    ...
    DefaultScannedTemplatesDescriptorBuilder.prototype.internalScanTemplate = function(file) {
      if (this.templatesCache[file] != null) {
        return Q.fcall((function(_this) {
          return function() {
            _this.debug("Found template " + file + " already cached");
            return _this.templatesCache[file];
          };
        })(this));
      }
    ...
    DefaultScannedTemplatesDescriptorBuilder.prototype.internalFindIncludedTemplates = function(filePath, fileContents) {
      return Q.fcall((function(_this) {
        ...
        return function(deps) {
          var dep, promises, _i, _len;
          if (!(deps != null ? deps.length : void 0)) {
            return [];
          }
          for (_i = 0, _len = deps.length; _i < _len; _i++) {
            dep = deps[_i];
            promises = _this.internalScanTemplate(dep);
          }
