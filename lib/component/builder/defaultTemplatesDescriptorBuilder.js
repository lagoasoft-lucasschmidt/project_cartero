(function() {
  var DefaultScannedTemplatesDescriptorBuilder, DefaultTemplatesDescriptorBuilder, Promise, ScannedTemplatesDescriptorBuilder, TemplatesDescriptorBuilder, defaultOptions, fs, path, _,
  ...
  DefaultTemplatesDescriptorBuilder = (function(_super) {
    ...
    DefaultTemplatesDescriptorBuilder.prototype.buildTemplatesDescriptors = function(callback) {
      ...
      return Promise.promisify(this.scanner.scanTemplates)().then((function(_this) {
        return function(scannedTemplates) {
          _this.debug("ScannedTemplates=" + (JSON.stringify(scannedTemplates, null, 2)));
