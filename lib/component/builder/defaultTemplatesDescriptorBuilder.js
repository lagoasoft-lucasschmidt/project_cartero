    ...
    DefaultTemplatesDescriptorBuilder.prototype.buildTemplatesDescriptors = function(callback) {
      ...
      return Q.nfcall(this.scanner.scanTemplates).then((function(_this) {
        return function(scannedTemplates) {
          ...
          _this.trace("Created scannedTemplates, now, will build real templates descriptions");
        ...
        return function(result) {
          ...
          _this.debug("Finished calculating all Template descriptors=" + result.length + "=" + (JSON.stringify(templatesNames, null, 2)));
          librariesNames = _.sortBy(_.keys(_this.libraries.getCalculatedLibraries()));
          _this.debug("All Libraries generated during this were " + librariesNames.length + "=" + (JSON.stringify(librariesNames, null, 2)));
