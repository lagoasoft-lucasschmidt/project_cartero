(function() {
  var CarteroFileDescriptorBuilder, DefaultCarteroFileDescriptorBuilder, Q, Template, fs, mkdirp, path, saveCarteroJSON, _,
      ...
      return this.validateTemplates(templates).then((function(_this) {
        return function() {
          ...
          return saveCarteroJSON(carteroJson, _this.options).then(function() {
            _this.info("Successfully wrote Cartero File Descritor on " + filePath);
