(function() {
  ...
  MoveAssetsProcessor = (function(_super) {
    ...
    MoveAssetsProcessor.prototype.moveFilesInLibrary = function(carteroJSON, library, processedLibraries, files) {
      var file, newPath, otherLib, otherLibId, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _results;
      if (!_.contains(processedLibraries, library.id)) {
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          ...
          newPath = path.join(this.options.librariesDestinationPath, "library-assets", path.relative(this.options.bowerComponentsPath, file.path));
          files.push({
            src: file.path,
            dest: newPath
          });
    ...
    MoveAssetsProcessor.prototype.copyLibraryFiles = function(files) {
      ...
      return this.logger.info("created copy grunt job with options " + (JSON.stringify(copyOptions, null, 2)));
    };
