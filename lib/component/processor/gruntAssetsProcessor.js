(function() {
  var AssetsProcessor, GruntAssetsProcessor, Promise, fileExtension, fs, mkdirp, path, _,
  ...
  GruntAssetsProcessor = (function(_super) {
    ...
    function GruntAssetsProcessor(processorOptions, grunt, options) {
      ...
      this.libraryFiles = processorOptions.libraryFiles;
      if (this.libraryFiles === void 0) {
        this.libraryFiles = true;
      }
      this.viewFiles = processorOptions.viewFiles;
      if (this.viewFiles === void 0) {
        this.viewFiles = true;
      }
    }
