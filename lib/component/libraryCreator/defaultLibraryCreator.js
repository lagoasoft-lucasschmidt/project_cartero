(function() {
  var DefaultLibraryCreator, Library, LibraryCreator, LibraryFile, Promise, fileExists, findFilesInFolder, findFilesInFolders, findFoldersInFolder, fs, isFolder, kBundleDefaults, path, readFile, _,
