(function() {
  var AssetsProcessor, GruntAssetsProcessor, Promise, fs, path, readCarteroJSON, saveCarteroJSON, _;
  ...
  module.exports = function(grunt) {
    return grunt.registerMultiTask('project_cartero_assets_processor', function() {
      ...
      return readCarteroJSON(options).then(function(carteroJSON) {
        return Promise.promisify(processor.run, processor)(carteroJSON);
